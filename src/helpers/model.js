...
export class ClassificationModel {
    ...
    async visualize(x_test, y_test, uniqueLabels, predictions, encoder) {
        ...
        await this.chartController.plot_confusion_matrix(tensorflow.tensor(predictions), tensorflow.tensor(y_test), classes, uniqueLabels, this.id);
        await this.chartController.draw_classification_pca(x_test.values, encoder.inverseTransform(y_test), evaluation_result, uniqueLabels, this.id);
