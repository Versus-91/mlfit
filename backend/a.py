...
X_train, X_test, y_train, y_test = train_test_split(data.loc[:, data.columns != "ocean_proximity"], data.loc[:, data.columns == "ocean_proximity"], test_size=0.30, random_state=None)
